...
const RestaurantList = React.lazy(() => import("components/core/RestaurantList"));
  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-poppins sm:gap-10 md:gap-10 gap-[140px] items-center justify-end mx-auto pt-[51px] w-full ">
        <div className="flex flex-col md:gap-10 gap-[102px] items-center justify-start  w-[79%] lg:max-w-[1250px] mx-auto md:px-5">
